...
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertions.assertThatEventIsValid;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertions.assertThatKeyIsValid;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertions.assertThatNameIsValid;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertions.assertThatSpanStartedBeforeEnd;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MyEventsWithNotMatchingPrefix.A_BAR_EVENT;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_DYNAMIC_ENTRIES;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_EMPTY_TAGS_AND_EVENTS;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_NOT_MATCHING_PREFIX;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MySpan.SPAN_WITH_PREFIX;
import static org.springframework.observability.tracing.docs.DocumentedSpanAssertionsTests.MyTags.A_FOO_TAG;
